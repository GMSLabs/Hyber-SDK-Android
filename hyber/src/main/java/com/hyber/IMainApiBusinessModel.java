...
interface IMainApiBusinessModel {
    ...
    void sendPushDeliveryReport(@NonNull String messageId, @NonNull Long receivedAt, @NonNull MainApiBusinessModel.SendPushDeliveryReportListener listener);

    void getMessageHistory(@NonNull Long startDate, @NonNull MainApiBusinessModel.MessageHistoryListener listener);
